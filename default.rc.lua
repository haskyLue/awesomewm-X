...
conkywidget.text = '<span color="#FF4242">Ω</span>'
awful.widget.layout.margins[conkywidget] = { right = modifier.seperator_min }
-- button to run packer update
-- conkywidget:buttons(awful.util.table.join(awful.button({}, 1, function () 'zsh ' .. home_path .. '.config/awesome/themes/current/script.sh' end ) ) )
